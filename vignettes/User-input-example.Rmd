...
[TRIBE](http://tribe.greenelab.com/#/home) webserver.
...
ADAGEpath agree on many pathways. Here we list pathways significantly enriched
in GSEA but not associated with chosen active signatures.
We check whether they are assoicated with
any ADAGE signatures and how differentially active the associated signatures 
are.

```{r}
# pathways enriched in GSEA but not associated with ADAGE signatures
# in the top 10 layers of pareto fronts
GSEA_only <- c( "KEGG-Module-M00178: Ribosome, bacteria",
                "KEGG-Pathway-pae03010: Ribosome - Pseudomonas aeruginosa PAO1",
                "KEGG-Pathway-pae03070: Bacterial secretion system - Pseudomonas aeruginosa PAO1",
                "KEGG-Module-M00331: Type II general secretion pathway",
                "KEGG-Module-M00332: Type III secretion system",
                "KEGG-Module-M00023: Tryptophan biosynthesis, chorismate => tryptophan",
                "KEGG-Pathway-pae00280: Valine, leucine and isoleucine degradation - Pseudomonas aeruginosa PAO1",
                "KEGG-Pathway-pae00970: Aminoacyl-tRNA biosynthesis - Pseudomonas aeruginosa PAO1")

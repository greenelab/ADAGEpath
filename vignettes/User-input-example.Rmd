...
```{r}
# Because there are a lot of signatures passing the significance cutoff, we use
# bonferroni procedure instead of Benjamini–Hochberg procedure.
...
```{r}
active_sigs <- setdiff(active_sigs,c("Node119pos", "Node214neg", "Node299pos",
...
In this case, many signatures including Node35pos, Node233pos, Node269pos,
Node67pos, Node38pos, Node107pos, Node191pos are still uncharacterized by KEGG.
